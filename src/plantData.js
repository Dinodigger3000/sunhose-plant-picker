...
const calculateMatch = (plantData, profile) => {
  ...
  if (
    profile.lightLevel === 1 &&
    plantData.data.light_level.localeCompare("low") === 0
  ) {
    matchPercentage = matchPercentage + lightPriority;
  } else if (
    profile.lightLevel === 2 &&
    plantData.data.light_level.localeCompare("medium") === 0
  ) {
    matchPercentage = matchPercentage + lightPriority;
  } else if (
    profile.lightLevel === 3 &&
    plantData.data.light_level.localeCompare("high") === 0
  ) {
    matchPercentage = matchPercentage + lightPriority;
  } else if (
    profile.lightLevel === 4 &&
    plantData.data.light_level.localeCompare("very_high") === 0
  ) {
    matchPercentage = matchPercentage + lightPriority;
  }
